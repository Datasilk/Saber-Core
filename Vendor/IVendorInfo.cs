...
namespace Saber.Vendor
{
    ...
    {
        /// <summary>
        /// The key used to identify the vendor plugin. This is used to find the namespace for your plugin (e.g. Saber.Vendors.MyPlugin) 
        ...
        /// <summary>
        /// Optional. The relative path (/editor/vendors/my-plugin/icon.svg) to an SVG icon used within Saber's Editor
        /// </summary>
        string Icon { get; set; }
