namespace Saber.Vendor
{
    public class EmailType
    {
        ...
        /// <summary>
        /// The human-readable name of your email message type, used to display in Saber's Email Action Settings section within the Website Settings tab.
        /// </summary>
        ...
        /// gulpfile.js file. When your plugin is installed within Saber, all HTML files within your /emails/ folder will be copied to
        /// Saber's /Content/emails/ folder, so make sure your HTML filenames are unique to your plugin so they do not overwrite HTML files
